# 🧪 PostgreSQL 18 HA Lab — Raport przebiegu scenariuszy
...
> Strona interaktywna (GitHub Pages): [`run-report_PL.html`](run-report_PL.html). Wersja EN: [RUN_REPORT.md](RUN_REPORT.md).
...
_Wygenerowano: 2026-05-31 11:18:26_
